...
An Operator can be used for various reasons. The most common purposes of operators are managing database clusters, preparing database schemas, and restoring backups.

I'd avoid using `etc` in your leading sentence.
