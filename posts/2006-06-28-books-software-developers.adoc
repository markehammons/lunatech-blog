...
<p style="text-align:left"><img style="margin-right:1em" src='../media/2006-06-28-books-software-developers/books-for-developers-codecomplete.png' alt='Code Complete' /><img style="margin-right:1em" src='../media/2006-06-28-books-software-developers/ooks-for-developers-pragmaticprogrammer.png' alt='The Pragmatic Programmer' /><img src='../media/2006-06-28-books-software-developers/books-for-developers-effectivejava.png' alt='Effective Java' /> </p>
