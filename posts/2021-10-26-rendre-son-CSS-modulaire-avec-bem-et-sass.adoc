...
* Éléments : Tous les éléments du bloc parent commenceront par le nom du parent suivi de "\\__" (ex: .menu\\__link)
* Modificateur : Les modificateurs de nos éléments commenceront par "--" (ex : .menu\\__link--active)
