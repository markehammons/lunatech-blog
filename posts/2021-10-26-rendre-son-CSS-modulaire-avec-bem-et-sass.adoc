...
* Éléments : Tous les éléments du bloc parent commenceront par le nom du parent suivi de "\_\_" (ex: .menu\_\_link)
* Modificateur : Les modificateurs de nos éléments commenceront par "--" (ex : .menu\_\_link--active)
